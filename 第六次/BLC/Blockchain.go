...
func SJB_CreateBlockchainWithGenesisBlock(address string) *SJB_Blockchain {
...
func SJB_BlockchainObject() *SJB_Blockchain {
...
func (blockchain *SJB_Blockchain) SJB_MineNewBlock(from []string, to []string, amount []string) {
	...
	for index,address := range from {
		...
		tx := SJB_NewSimpleTransaction(address, to[index], int64(value), utxoSet,txs)
		txs = append(txs, tx)
	}
	//奖励
